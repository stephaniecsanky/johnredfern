...
if (!dojo.hostenv.findModule('xg.custom.shared.messagecatalogs.en_US', false)) {
dojo.provide('xg.custom.shared.messagecatalogs.en_US');dojo.evalObjPath('xg.index.nls',true);dojo.lang.mixin(xg.index.nls,xg.index.i18n,{photos:'Artwork',myAlbums:'My Albums',videos:'Art Videos',myVideos:'My Art Videos',pleaseEnterSomeFeedback:'Please type your comments below:'});dojo.evalObjPath('xg.photo.nls',true);dojo.lang.mixin(xg.photo.nls,xg.index.i18n,{photos:'Artwork',pleaseSelectPhotoToUpload:'Please select a picture to upload.',importingNofMPhotos:function(n,m){return'Importing <span id="currentP">'+n+'</span> of '+m+' pictures.'},takingYou:'Taking you to see your pictures…',weCouldntFind:'We couldn\'t find any pictures! Why don\'t you try one of the other options?',photosFromAnAlbum:'Albums'});dojo.evalObjPath('xg.shared.nls',true);dojo.lang.mixin(xg.shared.nls,xg.index.i18n,{uploadAPhoto:'Upload a Picture',uploadAPhotoEllipsis:'Upload a Picture…'});dojo.evalObjPath('xg.uploader.nls',true);dojo.lang.mixin(xg.uploader.nls,xg.index.i18n,{photosUploadHeader:'Pictures to Upload',photosDragOutInstructions:'Drag pictures out to remove them',photosDragInInstructions:'Drag Pictures Here',photosSelectInstructions:'Select a Picture',photosFiles:'Artwork',photosUploadingStatus:function(n,m){return'Uploading Picture '+n+' of '+m;},photosErrorTooManyTitle:'Too Many Pictures',photosErrorTooManyDescription:function(n){return'We\'re sorry, but you can only upload '+n+' pictures at a time.';},photosErrorContentTypeNotAllowedDescription:'We\'re sorry, but picture uploading has been disabled.',photosBatchEditorLabel:'Edit Information for All Artwork',photosApplyThisInfo:'Apply this info to the pictures below',photosUploadSuccessfulDescription:'Please wait while we take you to your pictures...',photosUploadPendingDescription:'Your pictures were successfully uploaded and are awaiting approval.',photosUploadLimitWarning:function(n){return'You can upload '+n+' pictures at a time.';},photosUploadLimitCountdown:function(n){switch(n){case 0:return'You\'ve added the maximum number of pictures.';case 1:return'You can upload 1 more picture.';default:return'You can upload '+n+' more picture.';}},photosIHaveTheRight:'I have the right to upload these pictures under the <a href="/main/authorization/termsOfService">Terms of Service</a>',albumProperty:'Album',videosUploadHeader:'Art Videos to Upload',videosFiles:'My Art Videos'});dojo.evalObjPath('xg.video.nls',true);dojo.lang.mixin(xg.video.nls,xg.index.i18n,{pleaseSelectVideoToUpload:'Please select an art video to upload.',videos:'art videos'});
}